...
Miary używane do oceny jakości uzyskanego w trakcie nauki modelu są obliczane na podstawie macierzy pomyłek, którą zaprezentowano na Rys. \ref{fig:confusion_matrix}. Przewidziane wartości pochodzą od modelu, a rzeczywiste są poprzypisywane próbkom. Najlepsza sytuacja występuje, gdy najwięcej próbek znajduje się na przekątnej, w komórkach oznaczonych kolorem zielonym. Oznaczają one poprawne klasyfikacje - zarówno jako przypadki klasy negatywnej i pozytywnej. 
...
\begin{itemize}
    ...
    \item węzłów wewnętrznych (ang. internal node) – węzłów, w których zachodzi podział danych ze względu na wybraną cechę,
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{rysunki/Decision-tree-illustration.png}
...
\begin{itemize}
    ...
    \item wartość spadku w predykcji, przy której ma dojść do podziału \cite{rfc_documentation}. 
\end{itemize}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{rysunki/random-forest.jpg}
