...
Następne warte uwagi badania wykorzystują m.in. SHAP i PFI w tłumaczeniu algorytmu łączącego w sobie \textit{transfer learning}, autoenkodery i modele regresyjno-klasyfikacyjne w celu predykcji posiadania choroby Alzhaimera i MCI (ang. \textit{Mild Cognitive Impairment}) \cite{shap_pfi_research}. Wyniki badań wskazują, że metody mogą zostać wykorzystane równolegle - SHAP do globalnej oceny wpływów cech, a PFI do walidacji modelu. 
